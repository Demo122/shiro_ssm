        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form" method="post" >
                    <input name="name" placeholder="用户名 | 邮箱" value="11@qq.com" type="text" lay-verify="required" class="layui-input">
                    <hr class="hr15">
                ...
                <form class="layui-form" >
                    ...
                    <div class="layui-row">
                        <div class="layui-col-md6">
                            <input name="activeCode" lay-verify="required" placeholder="验证码"  type="text" class="layui-input" >
                        </div>
                    ...
                    <hr class="hr15">
                    <input class="loginin" value="登录" lay-submit lay-filter="loginByEmailVerifyCode" style="width:100%;" type="submit">
                    <hr class="hr20">
                </form>
            </div>
        </div>
